...
const translations={
  pt:{
    nav:{about:'Sobre',services:'Serviços',expertise:'Experiência',founder:'Fundador',impact:'Impacto',certifications:'Certificações',approach:'Abordagem',contact:'Fale connosco'},
    ...
    founder:{eyebrow:'A pessoa por detrás da LCON DIGITAL',title:'Fundada por Leandro Costa.',role:'FUNDADOR & CONSULTOR SAP',p1:'Com quase 10 anos de experiência em projetos SAP, incluindo 6 anos dedicados exclusivamente aos módulos financeiros como Senior SAP FI/CO/RE-FX Consultant e Team Leader, Leandro fundou a LCON DIGITAL para proporcionar uma abordagem mais focada e pragmática à consultoria SAP e à transformação digital.',p2:'O trabalho combina compreensão funcional, conhecimento técnico e um forte foco no problema de negócio por detrás de cada requisito SAP.',c1:'Greenfield & Brownfield',c2:'Processos financeiros avançados',c3:'Gestão patrimonial, tesouraria e orçamental',c4:'Ligação entre ambas as perspetivas',c4title:'Negócio & Tecnologia',linkedin:'Ver LinkedIn →'},
    impact:{eyebrow:'Impacto',title:'Confiança em soluções SAP à escala nacional.',lead:'Projetos de referência no setor público sustentam esta experiência, com responsabilidade sobre milhares de milhões de euros em ativos públicos.',tag1:'S/4HANA GREENFIELD IMPLEMENTATION',desc1:'em reservas financeiras geridas por uma das maiores entidades públicas de proteção social do país.',sub1:'€25B+ processados anualmente em receita.',sub1extra:'Gestão de carteira de 2 500+ imóveis e casas arrendadas.',tag2:'S/4HANA BROWNFIELD CONVERSION',desc2:'em capitais próprios geridos por um operador nacional de infraestruturas de transporte.',sub2:'€1.5B+ em receitas operacionais anuais.',sub2extra:'€1B+ em valor de ativos fixos e gestão de 14 000 km de rede.',note:'Valores baseados nos relatórios e contas públicos mais recentes de cada organização. Os nomes dos clientes não são divulgados por motivos de confidencialidade.'},
    certifications:{eyebrow:'Certificações',title:'Certificado pela SAP.',lead:'Certificações SAP obtidas por Leandro Costa, verificáveis publicamente e que sustentam o nível de exigência técnica da LCON DIGITAL.',issuer:'Emitido por SAP',verify:'Verificar no Credly →'},
  ...
  en:{
    nav:{about:'About',services:'Services',expertise:'Expertise',founder:'Founder',impact:'Impact',certifications:'Certifications',approach:'Approach',contact:"Let's talk"},
    ...
    founder:{eyebrow:'The person behind LCON DIGITAL',title:'Founded by Leandro Costa.',role:'FOUNDER & SAP CONSULTANT',p1:'With nearly 10 years of experience in SAP projects, including 6 years exclusively dedicated to financial modules as a Senior SAP FI/CO/RE-FX Consultant and Team Leader, Leandro founded LCON DIGITAL to provide a more focused, pragmatic approach to SAP consulting and digital transformation.',p2:'The work combines functional understanding, technical awareness and a strong focus on the business problem behind every SAP requirement.',c1:'Greenfield & Brownfield',c2:'Advanced financial processes',c3:'Real estate, treasury & public budget management',c4:'Bridging both perspectives',c4title:'Business & Technology',linkedin:'View LinkedIn →'},
    impact:{eyebrow:'Impact',title:'Trusted with national-scale SAP solutions.',lead:'Flagship public-sector engagements underpin this experience, carrying responsibility over billions of euros in public assets.',tag1:'S/4HANA GREENFIELD IMPLEMENTATION',desc1:'in financial reserves managed by one of the largest public social-protection institutions in the country.',sub1:'€25B+ processed annually in revenue.',sub1extra:'Portfolio management of 2,500+ properties and leased homes.',tag2:'S/4HANA BROWNFIELD CONVERSION',desc2:'in equity managed by a national transport infrastructure operator.',sub2:'€1.5B+ in annual operating revenue.',sub2extra:'€1B+ in fixed asset value and management of 14,000 km network.',note:'Figures based on the latest publicly available annual report of each organization. Client names are withheld for confidentiality.'},
    certifications:{eyebrow:'Certifications',title:'Certified by SAP.',lead:'SAP certifications held by Leandro Costa, publicly verifiable, underpinning the technical standard behind LCON DIGITAL.',issuer:'Issued by SAP',verify:'Verify on Credly →'},
