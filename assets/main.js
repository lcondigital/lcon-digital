...
const translations={
  ...
  en:{
    ...
    impact:{eyebrow:'Impact',title:'Trusted with national-scale SAP programs.',lead:'Flagship public-sector engagements underpin this experience, carrying responsibility over billions of euros in public assets.',tag1:'S/4HANA GREENFIELD IMPLEMENTATION',desc1:'in financial reserves managed by one of the largest public social-protection institutions in the country.',sub1:'€25B+ processed annually in revenue | Portfolio management of 2,500+ properties and leased homes.',tag2:'S/4HANA BROWNFIELD CONVERSION',desc2:'in equity managed by a national transport infrastructure operator.',sub2:'€1.5B+ in annual operating revenue | €1B+ in fixed asset value and management of 14,000 km network.',note:'Figures based on the latest publicly available annual report of each organization. Client names are withheld for confidentiality.'},
